...
mkdir -p /data/db && mongod --fork --logpath /var/log/mongod.log && mongoimport --uri="mongodb://localhost:27017/flashbots" --collection flashbots_blocks --type json --file flashbots_blocks.json
...
mkdir -p /data/db && mongod --fork --logpath /var/log/mongod.log && mongoimport --uri="mongodb://localhost:27017/flashbots" --collection sandwich_results --type json --file sandwich_results.json
...
mkdir -p /data/db && mongod --fork --logpath /var/log/mongod.log && mongoimport --uri="mongodb://localhost:27017/flashbots" --collection arbitrage_results --type json --file arbitrage_results.json
...
mkdir -p /data/db && mongod --fork --logpath /var/log/mongod.log && mongoimport --uri="mongodb://localhost:27017/flashbots" --collection liquidation_results --type json --file liquidation_results.json
